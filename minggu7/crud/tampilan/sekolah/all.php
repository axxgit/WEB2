...
<div>
	...
	<div style="clear:both">&nbsp;</div> <table class="data">  
		<thead>  
			<tr>   
				<th>No</th>   
				<th>Nama</th>   
		...
		<tbody>  
			...
			foreach ($data as $key) {  
				...
				<tr>  
					...
					<td><a href="proses/sekolah/download.php?id=<?php echo $key['id'];?>">Download</a></td>   <td><a href="index.php?p=sekolah&m=edit&id=<?php echo $key['id'];?>">Ubah</a></td>   <td><a onclick="return confirm('Hapus Data<?php echo $key['nama'];?>')" <a href="proses/sekolah/hapus.php?id=<?php echo $key['id'];?>">Hapus</a></td>  
				</tr>  
				<?php  
				$i++;  
			} 
